...
This roadmap describes how the Goose fork should evolve into a CHMARL research assistant distribution.
...
- Change application metadata from generic Goose to CHMARL Goose.
