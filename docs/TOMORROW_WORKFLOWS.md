# Tomorrow workflows for CHMARL Goose

This document describes practical workflows for using the CHMARL/Tomorrow Goose fork with the EcoFair-CH-MARL project.
...
Identify which assumptions are maritime-specific and which can generalize to other Tomorrow logistics settings.
```
...
Use `recipes/chmarl-tomorrow-planner.yaml`.
...
## Workflow 6: Plan Tomorrow extensions
...
Create a Tomorrow research roadmap based on CHMARL.
